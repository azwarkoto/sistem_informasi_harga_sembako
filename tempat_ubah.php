...
<div class="page-header">
    <h1>Ubah Data Kios</h1>
</div>
<div class="row">
    <div class="col-sm-6">
        <?php if ($_POST) include 'aksi.php' ?>
        <form method="post" action="?m=tempat_ubah&ID=<?= $row->id_kios ?>" enctype="multipart/form-data">
            <div class="form-group">
                <label>Nama Kios <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_kios" value="<?= $row->nama_kios ?>" />
            </div>
            <div class="form-group">
