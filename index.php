...
<head>
  ...
  <title>Sistem Informasi Harga Sembako</title>
...
<body>
      ...
      <div id="navbar" class="navbar-collapse collapse ">
        <ul class="nav navbar-nav">
          <?php if ($_SESSION['login']) : ?>
            <li><a href="?m=tempat"><span class="glyphicon glyphicon-th"></span> KIOS</a></li>
            <li><a href="?m=galeri"><span class="glyphicon glyphicon-list-alt"></span> Sembako</a></li>
            <li><a href="?m=harga"><span class="glyphicon glyphicon-tags"></span> Harga</a></li>
            <li><a href="?m=password"><span class="glyphicon glyphicon-lock"></span> Password</a></li>
            <li><a href="aksi.php?act=logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
          <?php else : ?>
            <li><a href="?m=daftar_kios"><span class="	glyphicon glyphicon-th"></span> KIOS</a></li>
            <li><a href="?m=harga_list"><span class="glyphicon glyphicon-tags"></span> HARGA</a></li>
  ...
  <footer class="footer bg-success">
    <div class="container">
      <p>Copyright &copy; <?= date('Y') ?> Sistem Informasi Harga Sembako <em class="pull-right">Juni 2019</em></p>
    </div>
  </footer>
